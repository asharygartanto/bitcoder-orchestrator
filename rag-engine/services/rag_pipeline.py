...
class RAGPipeline:
    ...
    def _build_system_prompt(
        ...
        return (
            ...
            "ATURAN KETAT:\n"
            "- JANGAN menyertakan daftar referensi, sumber, nama file, atau link apapun di jawabanmu.\n"
            "- JANGAN menyebutkan nama file dokumen atau dokumen referensi di jawabanmu.\n"
            "- Jika informasi TIDAK tersedia dalam konteks yang diberikan, jawab PERSIS seperti ini: "
            "\"Maaf, saya tidak memiliki informasi mengenai [topik yang ditanyakan]. "
            "Silakan ajukan pertanyaan lain yang terkait dengan data atau dokumen yang tersedia.\"\n"
            "- JANGAN tambahkan teks lain setelah jawaban tersebut.\n"
            "- JANGAN buat jawaban yang menggabungkan potongan teks yang tidak relevan.\n\n"
            f"### Konteks:\n{context_text}"
        )
